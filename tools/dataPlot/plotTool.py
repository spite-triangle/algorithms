...
class Application(tk.Frame):
    ...
    def creatWidgets(self):
        ...
        self.setPosScale(self.filePathBtn,14,3,2,1)
    ...
    def initWidget(self):
        ...
        if os.path.getsize(self.configFilePath):
            # 读取配置文件
            configFile = open(self.configFilePath,'r',encoding="utf-8")
            self.fileConfigs = json.load(configFile)
            configFile.close()
        ...
        # 用于之后文件的写出
        self.configFile = open(self.configFilePath,'w',encoding="utf-8")
    ...
    def plotFigures(self):
        ...
        for col in yAxis:
            ...
            plt.legend(names)
            if self.isSaveFig:
                plt.savefig("./image/"+"Fig" + xAxis + "_" + col+".jpg")
        plt.show()
...
if(__name__ == "__main__"): 
    ...
    app = Application(root,blockSize,"./config/filesConfig.json")
    root.mainloop()