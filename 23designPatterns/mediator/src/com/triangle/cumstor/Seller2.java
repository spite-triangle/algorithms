...
public class Seller2 extends Cumstor{

	public Seller2(String name,Mediator mediator){
		// 持有中介
	...
	public void receiveMessage(String info,Cumstor cumstor) {
		...
		if (info.equals("ask") && cumstor instanceof Seller1) {
			System.out.println("Seller1:15");
		}
	}
